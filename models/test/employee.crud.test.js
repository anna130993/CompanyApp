...
describe('Employee', () => {
  ...
  describe('Reading data', () => {
    let depId;
    before(async () => {
      const testDep = new Department({ name: 'TestDep'});
      const savedDep = await testDep.save();
      depId = savedDep._id;

      const testEmpOne = new Employee({ firstName: 'Employee #1', lastName: 'Surname1', department: depId });
      await testEmpOne.save();

      const testEmpTwo = new Employee({ firstName: 'Employee #2', lastName: 'Surname2', department: depId });
    ...
    it('should return proper document by various params with "findOne" method', async () => {
      const expectedEmployee = { firstName: 'Employee #1', lastName: 'Surname1', department: depId};
  ...
  describe('Creating data', () => {
    ...
    it('should insert new document with "insertOne" method', async () => {
        const employee = new Employee({ firstName: 'Employee #1', lastName: 'Surname', department: 'TestDep' });
        await employee.save();
  ...
  describe('Updating data', () => {
    beforeEach(async () => {
        const testEmpOne = new Employee({ firstName: 'Employee #1', lastName: 'Surname', department: 'TestDep' });
        await testEmpOne.save();
      
        const testEmpTwo = new Employee({ firstName: 'Employee #2', lastName: 'Surname', department: 'TestDep' });
        await testEmpTwo.save();
    });
